...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    const factoryAttackerContract = await ethers.getContractFactory(
      "TheRewarderAttackerContract",
      attacker
    );
    this.attackerContract = await factoryAttackerContract.deploy(
    ...
    //take flash loan and deposit funds to get the reward
    await this.attackerContract.connect(attacker).attack(TOKENS_IN_LENDER_POOL);
  });
